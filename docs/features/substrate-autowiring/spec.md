...
**Status:** accepted — D1 decided (close-out wrapper, §4). P0 (`--meta` CLI) landed (dossier #102); P1/P2 buildable.
**Owner:** @itsHabib
**Date:** 2026-07-25 (D1 locked 2026-07-27)
...
1. ~~**D1 home**~~ — **RESOLVED (2026-07-27): the close-out wrapper.** Ships faster, keeps gate pure (zero dossier-awareness), and is a clean graduation point to gate-side emission if a non-wrapped gate path ever appears.
