...
> | [`reconciliation-brief.md`](reconciliation-brief.md) | handoff prompt: fold the ten independent ownership streams into one org loop | **open question**; hand to a fresh analyst, output is a vocabulary + build order |
