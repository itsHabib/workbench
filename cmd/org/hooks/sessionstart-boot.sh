#!/usr/bin/env bash
# SessionStart hook: inject a role's current prose card into a fresh session.
#
...
#
# Longest matching prefix wins. No mapping, no org binary, no registered card — all exit
