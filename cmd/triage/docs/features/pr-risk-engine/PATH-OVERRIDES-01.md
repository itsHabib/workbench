...
|---|---|---|
| Merge-authorization + the exit-code seam | workbench `cmd/gate/internal/state/**`, `cmd/gate/internal/verify/**`, `cmd/gate/internal/capability/**`, `cmd/gate/internal/tier/**`, `cmd/gate/main.go`, `cmd/triage/internal/floor/overrides.go` | **T3** |
