...
- [Local team rescue](team-rescue/README.md): compare solo iteration, a delivery
  lead and an independent challenger on a real webhook service. Fleet job
  claims, native model receipts, executable acceptance checks and recovery drills.
